...
public class JointOrientation : MonoBehaviour
{
    ...
    void Update ()
    {
		...
		transform.rigidbody.MoveRotation( Quaternion.RotateTowards(transform.rigidbody.rotation, _antiYaw * antiRoll * Quaternion.LookRotation (myo.transform.forward), 60) );
